...
// name, attack bonus, attack type, damage bonus, defense bonus, toughness bonus, resists, weaknesses, summon skill (leave blank for unsummonable)
	...
	new NPCTemplate("Vampire",			4, 1, 3, 3, 0, [], [ "DAMAGE_FLAME", "DAMAGE_SILVER" ]),
	new NPCTemplate("Bloodfiend",		2, 1, 2, 0, 0, [], [ "DAMAGE_FLAME" ]),
	new NPCTemplate("Shambles",			2, 1, 4, 0, 4, [], [ "DAMAGE_SILVER" ], "Necromancy"),
	new NPCTemplate("Flesh Atronach",	4, 1, 3, -2, 4, [ "DAMAGE_FLAME"], [ "DAMAGE_SHOCK" ], "Necromancy"),
	new NPCTemplate("Reanimated Animal (Small)", -2, 1, -2, 0, -2, [], [], "Necromancy"),
	new NPCTemplate("Reanimated Animal (Medium)", 0, 1, 0, -4, 0, [], [], "Necromancy"),
	new NPCTemplate("Reanimated Animal (Large)", 0, 1, 3, -5, 4, [], [], "Necromancy"),
	new NPCTemplate("Scamp",			0, 1, 0, 2, 2, [], [ "DAMAGE_SILVER" ], "Conjuration"),
	new NPCTemplate("Clannfear",		2, 1, 3, 0, 4, [], [ "DAMAGE_SILVER" ], "Conjuration"),
	new NPCTemplate("Flame Atronach",	3, 3, 4, 1, 0, [ "DAMAGE_FLAME" ], [ "DAMAGE_FROST", "DAMAGE_SILVER" ], "Conjuration"),
	new NPCTemplate("Frost Atronach",	2, 4, 3, -2, 4, [ "DAMAGE_FROST" ], [ "DAMAGE_FLAME", "DAMAGE_SILVER" ], "Conjuration"),
	new NPCTemplate("Storm Atronach",	2, 6, 3, -1, 2, [ "DAMAGE_SHOCK" ], [ "DAMAGE_SILVER" ], "Conjuration"),
	...
	new NPCTemplate("Daedroth",			4, 1, 3, -1, 4, [], [ "DAMAGE_SILVER" ], "Conjuration"),
	...
	new NPCTemplate("Large Animal",		2, 1, 3, -1, 4, [], [], "HandleAnimal"),
	new NPCTemplate("Spriggan",         3, 5, 3, 2, 0, [ "DAMAGE_POISON" ], [ "DAMAGE_FLAME" ], "NatureMagic"),
	new NPCTemplate("Lurcher",          0, 1, 4, -2, 4, [ "DAMAGE_POISON" ], [ "DAMAGE_FLAME" ], "NatureMagic"),
	new NPCTemplate("Wild Hunt (Small)", 0, 1, -2, 4, -2, [ "DAMAGE_POISON" ], [ "DAMAGE_FLAME" ], "NatureMagic"),
	new NPCTemplate("Wild Hunt (Medium)", 2, 1, 0, 0, 0, [ "DAMAGE_POISON" ], [ "DAMAGE_FLAME" ], "NatureMagic"),
	new NPCTemplate("Wild Hunt (Large)", 2, 1, 3, -1, 4, [ "DAMAGE_POISON" ], [ "DAMAGE_FLAME" ], "NatureMagic"),
	new NPCTemplate("Werewolf",			3, 1, 4, 1, 4, [], [ "DAMAGE_POISON", "DAMAGE_SILVER" ]),
	new NPCTemplate("Dwemer Spider",    0, 1, 1, -2, -1, [ "DAMAGE_POISON", "DAMAGE_SHOCK" ], [], "Dwemerology"),
	new NPCTemplate("Dwemer Sphere",    4, 1, 4, -3, 2, [ "DAMAGE_POISON", "DAMAGE_SHOCK" ], [], "Dwemerology"),
	new NPCTemplate("Dwemer Centurion", 3, 1, 6, -4, 6, [ "DAMAGE_POISON", "DAMAGE_SHOCK" ], [], "Dwemerology"),
	new NPCTemplate("Gargoyle",         3, 1, 4, -1, 6, [ "DAMAGE_PHYSICAL" ], [], "BloodMagic"),
	new NPCTemplate("Coagulant",        0, 1, 0, 0, 0, [], [], "BloodMagic"),
];
