...
const localizationList = [
	{
		...
		strings: [
			...
			[ "CHARACTER_NPC_DESCRIPTION", "This setting is only available for Gamemasters.  A character that is marked as an NPC can be played by any GM that add that character to their session." ],
			[ "BIOGRAPHY", "Biography" ],
