...
const localizationList = [
	{
		...
		strings: [
			...
			[ "ATTRIBUTE_LEVEL_0", "Pathetic" ],
			[ "ATTRIBUTE_LEVEL_1", "Poor" ],
			[ "ATTRIBUTE_LEVEL_2", "Average" ],
			[ "ATTRIBUTE_LEVEL_3", "Good" ],
			[ "ATTRIBUTE_LEVEL_4", "High" ],
			[ "ATTRIBUTE_LEVEL_5", "Exceptional" ],
			[ "ATTRIBUTE_LEVEL_6", "Supernatural!" ],
			[ "SKILL_LEVEL_0", "Novice" ],
			[ "SKILL_LEVEL_1", "Apprentice" ],
			[ "SKILL_LEVEL_2", "Journeyman" ],
			[ "SKILL_LEVEL_3", "Expert" ],
			[ "SKILL_LEVEL_4", "Master" ],
			...
			[ "NUMERIC_SETTING_LINE_1", "Enable this option to display" ],
			[ "NUMERIC_SETTING_LINE_2", "raw numbers in" ],
			[ "NUMERIC_SETTING_LINE_3", "character summaries." ],
			[ "NUMERIC_DISPLAY_DESCRIPTION", "When summarizing a character's stats, ESO Rollplay can display skills and attributes in two ways:" ],
			[ "NUMERIC_DISPLAY_NUMERIC", "Numeric" ],
			[ "NUMERIC_DISPLAY_NUMERIC_TEXT", "Show me the raw numbers." ],
			[ "NUMERIC_DISPLAY_DESCRIPTIVE", "Descriptive" ],
			...
			[ "OOC_INFO", "OOC Info" ],
			[ "OOC_INFO_DESCRIPTION", "Include any OOC info for other RPers here, such as:\n- Character limits (no maiming, no ERP, etc)\n- RP Hooks (info others can use to involve this character)\n- Availability (e.g. US Eastern time evenings)\n- Other Accommodations (slow typer, frequent breaks, etc)" ],
			[ "OOC_INFO_HELPER", "(CURRENT/MAX characters)" ],
			[ "BIOGRAPHY", "Biography" ],
